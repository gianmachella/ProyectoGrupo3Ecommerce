              ...
              <div class="modal-de-compra">
                ...
                <div class="container2">
                  ...
                  <ul class="social-media">
                    <li><span class="ion-social-twitter"><ion-icon name="logo-instagram">boludeces aca </ion-icon></span></a></li>
                    <li><span class="ion-social-facebook"><ion-icon name="logo-facebook">boludeces aca </ion-icon></span></a></li>
                    <li><span class="ion-social-linkedin"><ion-icon name="logo-twitter">boludeces aca </ion-icon></span></a></li>
                  </ul>
                  <hr style="border: 1px inset;width:90%;">
                  <h4>$30 p/dna</h4>
                ...
                <div class="card text-center">
                  <div class="card-body">
                    ...
                    <p class="card-text">Cupcake rellenos o sin relleno, personalizados con fondant.
                      <h3>$30 p/dna</h3>
                    <button href="#modal2" data-toggle="modal" class="btn btn-primary btn-lg btn-block" type="submit" name="">Miralo</button>
                  </div>
                </div>
             </div>
            ...
            <div class="col-md-4">
                  <div class="card text-center">
                    <div class="card-body">
                      ...
                      <p class="card-text">Cupcake rellenos o sin relleno, personalizados con crema.
                      <h3>$30 p/dna</h3>
